...
from  studioflow_core.controllers.execution_client_form import ClientAbandoned
from studioflow_core.controllers.sdk_context import SDKContext
from studioflow_core.entities.execution import Execution
from studioflow_core.logger import StudioFlowLogger
from studioflow_core.modules import import_as_new
...
from studioflow_core.usage import execution_usage
from studioflow_core.utils.datetime import now_str
    ...
    with SDKContext(execution, client, repositories):
        ...
        try:
            ...
            try:
                ...
                StudioFlowLogger.capture_exception(e_final)
