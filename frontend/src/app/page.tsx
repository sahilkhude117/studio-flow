...
export default function LandingPage() {
  ...
  return (
    <div className="flex min-h-[100dvh] flex-col ml-20">
      <header
      ...
      >
        <div className="container flex h-16 items-center justify-between">
          ...
          <div className="hidden md:flex gap-4 items-center">
            ...
            <Button onClick={() => router.push('/sign-up')} className="rounded-full">
              Get Started
          ...
          <div className="container px-4 md:px-6 relative">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button onClick={() => router.push('/sign-in')} size="lg" className="rounded-full h-12 px-8 text-base">
                  Get Started 
        ...
        <div className="container flex flex-col gap-8 px-4 py-10 md:px-6 lg:py-16">
          ...
          <div className="flex flex-col gap-4 sm:flex-row justify-between items-center border-t border-border/40 pt-8">
            <p className="text-xs text-muted-foreground">
              &copy; {new Date().getFullYear()} StudioFlow. All rights reserved.
            </p>
            <div className="flex gap-4">
